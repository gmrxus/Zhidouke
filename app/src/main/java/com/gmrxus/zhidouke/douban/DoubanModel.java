...
public class DoubanModel implements DoubanContract.Model {
  ...
  @Override
  public void getForNet(String date, final ResultListener listener) {
    String url = Urls.DOUBAN_MAIN_URL + date;
    Logger.d(url);
//        HttpUtils.getY(url, new HttpUtils.OnHttpRequestCallBackListener() {
//            @Override
